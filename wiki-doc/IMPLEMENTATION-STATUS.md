...
примера удалён. **P2-04…P2-05 остаются не начатыми.**

Подробный отчёт: [REVIEW-P2-03.md](REVIEW-P2-03.md).
**Итог: 624 passed, 1 skipped (Windows symlink), 0 failed; 159 subtests passed.**
...
- Всего (без test_publish и test_p1_acceptance): **584 passed, 1 skipped, 1 known failure**
