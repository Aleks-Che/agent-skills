...
[P2-04-ACCEPTANCE.json](P2-04-ACCEPTANCE.json). **P2-05 не начат.**
...
**Текущий полный набор: 632 теста — 631 passed, 1 skipped, 191 subtests passed.**
...
- Всего: **632 теста, 631 passed, 1 skipped, 191 subtests passed** при проверке 2026-09-19.
...
P2-05: эксплуатация (CLI-обёртка, версия, CHANGELOG, журнал, шаблоны ответов).
