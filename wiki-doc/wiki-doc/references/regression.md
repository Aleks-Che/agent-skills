...
Из `docs/` копируется только `dialect-support.md`, на который ссылается SKILL.md.
Его ссылки на тесты и общий каталог примеров служат доказательствами в исходном
